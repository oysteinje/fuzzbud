...
```bash
curl -fsSL https://raw.githubusercontent.com/oysteinje/fuzzbud/main/scripts/pim-me-up/install.sh | bash -s -- --system
```
...
4. If you choose an activation category, search and select roles (Tab to select, Enter to confirm)
5. Pick duration
